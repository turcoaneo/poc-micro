...
public class JwtAuthFilterEEM extends OncePerRequestFilter {
    private static final Logger logger = LoggerFactory.getLogger(JwtAuthFilterEEM.class);
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws ServletException, IOException {
        ...
        List<String> excludedEndpoints = Arrays.asList("/eem/eem-users/login", "/eem/eem-users/register", "/eem/working-hours");
